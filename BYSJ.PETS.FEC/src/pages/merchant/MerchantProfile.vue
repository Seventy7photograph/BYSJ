        ...
        <div class="profile-main">
          ...
          <div class="avatar-section">
            ...
            <div class="avatar-text">
              <h3>{{ userInfo.nickname || userInfo.shopName || '未设置昵称' }}</h3>
              <p class="username">{{ userInfo.username }}</p>
              <p class="shop-status">
                <el-tag :type="getShopStatusType(userInfo.shopStatus)">
                  {{ getShopStatusText(userInfo.shopStatus) }}
                </el-tag>
              </p>
            </div>
          </div>
            ...
            <el-row :gutter="20">
              <el-col :span="24">
                <el-form-item label="店铺描述：">
                  <el-input
                    v-model="userInfo.shopDescription"
                    type="textarea"
                    :rows="3"
                    placeholder="请输入店铺描述"
                    :disabled="!isEditing"
    ...
    if (response.data && response.data.code === 200) {
      ...
      if (updatedUser) {
        ...
        userStore.setUserInfo({
          ...
          shopDescription: userInfo.shopDescription
        })
      }
